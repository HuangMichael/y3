...
<form class="form-horizontal myform" id="detailForm">
    <div class="form-group">
        ...
        <div class="col-md-4 col-sm-4 col-lg-4">
            ...
            <input class="form-control" id="baseTableName" name="id" v-model="etlTable.baseTableName">
        </div>
        <div class="col-md-2 col-sm-2 col-lg-2">
            <label for="serviceTableName">业务表名</label>
        </div>
        <div class="col-md-4 col-sm-4 col-lg-4">
            <input class="form-control" id="serviceTableName" name="id" v-model="etlTable.serviceTableName">
        </div>
    </div>
    <div class="form-group">
